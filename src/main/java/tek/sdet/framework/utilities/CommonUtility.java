...
public class CommonUtility extends BaseSetup{
	...
	//why the CommonUtility need to extend BaseSetup?
	//To be able to access the instance of WebDriver
	//because we created a method getDriver() in our BaseSetup class
